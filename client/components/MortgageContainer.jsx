...
export default class PropertyForm extends Component {
  ...
  componentDidMount() {
    const inputSections = document.querySelectorAll('.MortgageContainer-inputs');
  ...
  render() {
    return (
      <div className="MortgageContainer">
        ...
        <div className="MortgageContainer-inputs" ref="inputs">
          <div className="MortgageContainer-inputWrapper">
            <Deposit />
            <GovernmentLoan />
            <MortgageSize />
            <HouseholdIncome />
